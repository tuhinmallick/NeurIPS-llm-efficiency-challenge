...
class AlpacaPrompter:
    ...
    def match_prompt_style(self):
        ...
        if self.prompt_style == PromptStyle.CHAT.value:
            ...
            # Changes for LILA dataset: https://huggingface.co/allenai/bhaskara
            #self.turn_format = "Question: {input}\n\nAnswer:"
            #self.turn_no_input_format = "Question: {instruction}\n\nAnswer:"
            #self.system_format = "SYSTEM: {system}\n"

            # Changes for NIPS
            self.turn_format = "{input}"
